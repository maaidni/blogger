!function(){function f(){var a=document.createElement("div");a.id="kamujahat";a.innerHTML='
<div class="inner">
    <div class="header">
        <h2>Ad Blocker Detected :(</h2> </div>
    <div class="isi">
        ...
        <div class="tutorial">
            ...
            <div class="2">
                <ol>
                    <li>Click on the AdBlock Plus icon in your browser
                    ...
                    <li>Click on "Enabled on this site" position
                    ...
                    <li>Once clicked, it should change to "Disabled on this site"
